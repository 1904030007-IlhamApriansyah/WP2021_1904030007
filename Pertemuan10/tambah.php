...
<html lang="en">
  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 p-5 pt-5">
      <!-- konten -->
      <h3><i class="fas fa-table"></i> Input Data Mahasiswa </h3><hr>
        ...
        <form method="POST" action="">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="Umur" placeholder="Umur" name="Umur" required autocomplete="off">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="Jenis_Kelamin" placeholder="Jenis Kelamin" name="Jenis Kelamin" required autocomplete="off">
            </div>
            <div class="mb-3">
                <label for="Kelas" class="form-label">Kelas :</label>
                <input type="text" class="form-control" id="Kelas" placeholder="Kelas" name="Kelas" required autocomplete="off">
            </div>
            <div class="mb-3">
