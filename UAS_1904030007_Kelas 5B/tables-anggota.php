...
<?php
    ...
    if (!isset($_POST['cari'])){
        $Table_Anggota = cari($_POST['keyword']);
    }

    $Table_Anggota = query("SELECT * FROM Table_Anggota");
?>
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <form action="" method="POST" class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                <div class="input-group">
                    <input class="form-control" type="text" name="keyword" id="keyword" placeholder="Cari berdasarkan Nama.." autocomplete="off" />
                ...
                <main>
                    ...
                    <table class="table table-striped">
                        <thead>
                            ...
                            <tbody>
                                <?php $no=1; ?>
                                <?php foreach ($Table_Anggota as $Tbl) : ?>
                                <tr>
                                    <th scope="row"><?php echo $no; ?></th>
                                    <td><?php echo $Tbl['No_Anggota']; ?></td>
                                    <td><?php echo $Tbl['Nama']; ?></td>
                                    <td><a href="detail-anggota.php?id=<?= $Tbl ['id']; ?>" class="btn btn-success" role="button"> Detail </a></td>
                                </tr>
                                <?php $no++ ?>
                                <?php endforeach ?>
                        </tbody>
